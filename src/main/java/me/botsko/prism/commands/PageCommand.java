...
public class PageCommand implements SubHandler {
    ...
    public void handle(CallInfo call) {
        ...
        // Get stored results
        final QueryResult results = Prism.cachedQueries.get( keyName );
        ...
        Prism.cachedQueries.replace( keyName, results );
        ...
        for ( final Handler a : paginated ){
            ...
            if( results.getParameters().allowsNoRadius() || results.getParameters().hasFlag( Flag.EXTENDED ) || Prism.config.getBoolean( "prism.messenger.always-show-extended" ) ) {
                am.showExtended();
            }
